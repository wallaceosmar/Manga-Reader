                    ...
                    <div class="row">
                        <div class="col-lg-8" style="min-height: 200px;">
                            <div class="page-header" style="border-bottom:2px solid #efefef;">
                                <h1>{'Lista de Mangas atualizados recentemente'|__}</h1>    
                            </div>
                        ...
                        <div class="col-lg-12">
                            <nav style="text-align: center;">
                                <ul class="pagination">
                                    ...
                                    {else}
                                    <li>
                                        <a href="{'manga-filter'|routing_generate:['controller' => 'pages', 'action' => 'recent-updates', 'pagination' => $pagination->preview]|base_url}" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                    </li>
                                    {/if}
                                    {for $i = $pagination->beginFor to $pagination->endFor}
                                    <li><a href="{'manga-filter'|routing_generate:['controller' => 'pages', 'action' => 'recent-updates', 'pagination' => $i]|base_url}">{$i}</a></li>
                                    {/for}
                                    ...
                                    {else}
                                    <li>
                                        <a href="{'manga-filter'|routing_generate:['controller' => 'pages', 'action' => 'recent-updates', 'pagination' => $pagination->next]|base_url}" aria-label="Next">
                                            <span aria-hidden="true">&raquo;</span>
                                        </a>
                                    </li>
                                    {/if}
